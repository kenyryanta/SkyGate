    ...
    <div class="row">
        <div class="col-lg-9">
            <div class="d-flex justify-content-between align-items-center mb-4">
                <h4 class="mb-0">Search Results ({{ $flights->count() }})</h4>
                <div class="dropdown">
                    ...
                    <ul class="dropdown-menu">
                        ...
                        <li><a class="dropdown-item" href="#">Duration (Shortest)</a></li>
                        <li><a class="dropdown-item" href="#">Departure (Earliest)</a></li>
                        <li><a class="dropdown-item" href="#">Arrival (Earliest)</a></li>
                    </ul>
                </div>
            </div>
            ...
            @if($flights->isEmpty())
                <div class="alert alert-info">
                    <i class="bi bi-info-circle me-2"></i>No flights found matching your criteria. Please try different search parameters.
                </div>
            @endif
